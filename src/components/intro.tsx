...
export const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        `.A frontend / full stack developer ready for a new challenge. `I&apos;m
        passionate about building modern web applications using React, Next.js,
        TailwindCSS and backend with your choice (MongoDB, PostgreSQL).
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <Button variant="outline" size="icon" asChild>
          <Link
            href="https://www.linkedin.com/in/majid-hassan-ab0263227?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
            aria-label="Linkedin"
            target="_blank"
          >
